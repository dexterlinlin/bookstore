package com.sylar.service.impl;

import org.apache.commons.lang.StringUtils;
import com.sylar.dao.UserDao;
import com.sylar.model.User;
import com.sylar.service.MailEngine;
import com.sylar.service.UserExistsException;
import com.sylar.service.UserManager;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.sylar.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.sylar.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
