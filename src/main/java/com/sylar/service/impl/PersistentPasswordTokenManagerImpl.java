...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.sylar.service.impl.PasswordTokenManager#generateRecoveryToken(com.sylar.model.User)
     */
    @Override
    ...
    /**
     * @see com.sylar.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.sylar.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.sylar.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
